package com.arsiu.eduhub.kafka.config
...
open class BaseKafkaConfig {
    ...
    protected fun <T : GeneratedMessageV3> createKafkaSender(props: MutableMap<String, Any>): KafkaSender<String, T> {
    ...
    protected fun <T : GeneratedMessageV3> createKafkaReceiver(
        ...
        val options = ReceiverOptions.create<String, T>(props).subscription(Collections.singleton(topic))
